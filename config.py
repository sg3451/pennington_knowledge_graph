...
# ---------------------------------------------------------------------------
PENNINGTON_ROR_ID = "https://ror.org/040cnym54"
PENNINGTON_OPENALEX_ID = "I103990859"  # OpenAlex institution ID for Pennington
...
OPENALEX_SELECT_FIELDS = ",".join([
    ...
    "keywords",
    "mesh",           # MeSH headings directly from PubMed
    "awards",               # funder + award ID
